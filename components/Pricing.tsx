        ...
        <div className="w-full max-w-xl bg-white border border-gray-200 rounded-[3rem] p-10 md:p-16 shadow-2xl shadow-gray-200/50 relative overflow-hidden">
          ...
          <div className="flex flex-col mb-10">
            <div className="flex items-center gap-3 mb-2">
              <span className="text-base text-gray-400 line-through font-bold">₹4,999</span>
          ...
          <button
            ...
            className="w-full bg-black text-white py-5 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-gray-200 active:scale-95 hover:bg-gray-800"
          >
            Get Started
          </button>
