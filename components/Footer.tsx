...
export const Footer: React.FC = () => {
  ...
  const handleStartNowClick = () => {
    // If already on pricing page, scroll to top of content
        ...
        <div className="grid md:grid-cols-4 gap-12 pb-16 border-b border-gray-100">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm font-bold text-gray-500">
              <button onClick={() => navigate('/')} className="hover:text-[#4285F4] text-left transition-colors">Home</button>
              <button onClick={() => navigate('/services')} className="hover:text-[#4285F4] text-left transition-colors">Services</button>
              <button onClick={() => navigate('/pricing')} className="hover:text-[#4285F4] text-left transition-colors">Pricing</button>
              <button onClick={() => navigate('/about')} className="hover:text-[#4285F4] text-left transition-colors">About</button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm font-bold text-gray-500">
              <button onClick={() => navigate('/privacy')} className="hover:text-[#4285F4] text-left transition-colors">Privacy Policy</button>
              <button onClick={() => navigate('/terms')} className="hover:text-[#4285F4] text-left transition-colors">Terms & Conditions</button>
              <button onClick={() => navigate('/refund')} className="hover:text-[#4285F4] text-left transition-colors">Refund Policy</button>
              <button onClick={() => navigate('/shipping')} className="hover:text-[#4285F4] text-left transition-colors">Shipping Policy</button>
            </div>
          </div>
        </div>
